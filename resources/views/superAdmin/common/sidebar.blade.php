...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item {{url()->current() == route('progress')||url()->current() == route('progress-add') ? 'active open' : ''}} ">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{url()->current() == route('progress') ? 'active' : ''}}">
                <a href="{{route('progress')}}" class="menu-link">
                  <div data-i18n="Progress">Progress</div>
                </a>
              </li>
              <li class="menu-item {{url()->current() == route('progress-add') ? 'active' : ''}}">
                <a href="{{route('progress-add')}}" class="menu-link">
                  <div data-i18n="Progress Add">Progress Add</div>
                </a>
              </li>
